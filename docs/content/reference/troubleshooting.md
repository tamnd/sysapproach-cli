...
Most of these come down to network reality or how sysapproach serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sysapproach rate-limits like any public site. sysapproach already paces
...
Where a surface is gated, sysapproach reads a cookie or token you supply
...
`sysapproach`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sysapproach actually did
