...
```
sysapproach <command> [arguments] [flags]
```

Run `sysapproach <command> --help` for the full flag list on any command. This
...
per operation you declare in `sysapproach/domain.go`.
